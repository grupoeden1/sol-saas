      ...
      <main className="relative z-10 flex-1 px-4 pb-12 pt-28 md:px-8">
        <div className="mx-auto max-w-6xl space-y-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-foreground">Prompts da IA</h1>
              <p className="mt-1 text-sm text-foreground-muted">
                Edite os prompts do sistema sem necessidade de deploy. Alterações refletem em ate 1 minuto.
              </p>
            </div>
            <Link
              href="/admin"
